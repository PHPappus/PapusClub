		...
		<div class="container">
			<form action="" class="form-horizontal form-border">
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" class="form-control" id="nombre" placeholder="DNI" style="max-width: 250px">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" class="form-control" id="nombre" placeholder="Apellido" style="max-width: 250px">
					</div>
				</div>
				<div class="form-group">
					<label for="" class="control-label col-sm-5">FECHA DE NACIMIENTO:</label>
					<div class="col-sm-7">
						<input class="datepicker" type="text" id="dp1" readonly="true">
					</div>
				</div>				
				<div class="form-group">
					<label for="" class="control-label col-sm-5">CELULAR:</label>
					<div class="col-sm-7">
						<input type="text" class="form-control" id="nombre" placeholder="Celular" style="max-width: 250px">
					</div>
				</div>
				<div class="form-group">
