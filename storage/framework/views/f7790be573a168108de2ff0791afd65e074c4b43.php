		...
		<div class="container">
			<form action="" class="form-horizontal form-border">
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" class="form-control" id="nombre" placeholder="UBICACIÓN" style="max-width: 250px">
					</div>
				</div>
				<div class="form-group">
					<label for="" class="control-label col-sm-5">CAPACIDAD:</label>
					<div class="col-sm-7">
						<input type="text" class="form-control" id="nombre" placeholder="CAPACIDAD" style="max-width: 250px">
					</div>
				</div>
				<div class="form-group">
					<label for="" class="control-label col-sm-5">ESTADO:</label>
					<div class="col-sm-7">
						<input type="text" class="form-control" id="nombre" placeholder="ESTADO" style="max-width: 250px">
					</div>
				</div>
				<br/>
				<br/>
...
<?php echo $__env->make('layouts.headerandfooter-al-admin-registros', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>