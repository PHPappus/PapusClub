...
<header class="header">
		...
		<nav class="main-menu">
			<div class="content-fluid" style="margin-left: 10%">
				<div class="logo">
					<div class="edit-logo">
						<a href="<?php echo URL::to('/admin-general'); ?>" title="Logo oficial de Papus Club">
				...
				<nav class="menu" id="menu">
					<ul>
						<li><a href="#"><?php echo Auth::user()->name; ?>  <span class="glyphicon glyphicon-user"></span></a>
								<ul>
									<li><a href="<?php echo URL::to('/cuenta-s'); ?>" title="ir a ver cuenta"target="_self">CUENTA</a></li>
							...
							<ul>
								...
								<li><a href="#" title="ir a postulante" target="_self">POSTULANTE</a>
									<ul>
										...
										<li><a href="<?php echo URL::to('/registar-postulante'); ?>" title="ir a registrar" target="_self">REGISTRAR POSTULANTE</a></li>
									</ul>
								</li>
							</ul>
						</li>
